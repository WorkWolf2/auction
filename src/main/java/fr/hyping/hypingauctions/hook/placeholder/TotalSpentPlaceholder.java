...
/**
 * Placeholder returning the total amount of money the player has spent in the
 * auction house.
 *
 * <p>
 * Usage: %hauctions_total_spent%
 */
public class TotalSpentPlaceholder implements IPlaceholderExtension {
    @Override
    public @Nullable String onReplace(AuctionPlayer player, String name, String[] args) {
        return Messages.formatMoney(player.getTotalSpent());
    }
}
